...
Depois foi necessário transformar esse layout em um software Full-Stack. Para isso, foi construído um Back-end em NestJS do absoluto zero. Esse backend substituiu os dados estáticos, conectando o painel de forma viva a um Banco de Dados na nuvem (MongoDB).
